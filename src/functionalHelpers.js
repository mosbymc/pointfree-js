...
function semigroupFactory(concatFn, type) {
    ...
    function _semigroup(x) {
        return Object.create({}, {
            _value: {
                value: emptyObj.isPrototypeOf(x) ? undefined : x
            },
            value: {
                get: function _getValue() {
                    return this._value;
                },
                set: function _setValue(val) {
                    this._value = val;
                }
            },
            concat: {
                value: function _concat(other) {
                    return this.isEmpty ? _semigroup(other.value)
                        : other.isEmpty ? _semigroup(this.value) : concatFn.call(this, other);
                }
            },
            constructor: {
                value: _semigroup
    ...
    _semigroup.empty = function _empty() {
        return _semigroup(Object.create(emptyObj));
    };
...
var p1 = { name: first('Nico'), isPaid: all2(true), points: sum(10), friends: ['Franklin'] },
...
console.log(sum(10).concat(sum(11)));
console.log(sum(1).toString());

console.log(structure(p1).concat(structure(p2)));

var sumSemigroup = semigroupFactory(function _sumConcat({ value: y }) {
    return this.isEmpty ? sumSemigroup(y) :
        y.isEmpty ? sumSemigroup(this.value) : sumSemigroup(this.value + y);
}, 'Sum');

console.log(sumSemigroup(10).concat(sumSemigroup(11)).value);

var strSemiGroup = semigroupFactory(function _strConcat(y) {
    return strSemiGroup(this.value.concat(y.value));
}, 'String');

var se = strSemiGroup('test'),
    se2 = strSemiGroup('ing'),
    se3 = strSemiGroup.empty(),
    se4 = se.constructor('ly');

console.log(se.value);
console.log(se2.value);
console.log(se3.value);

console.log(se.concat(se2).value);
console.log(se.concat(se3).value);

console.log(se2.concat(se).value);
console.log(se2.concat(se3).value);

console.log(se3.concat(se).value);
console.log(se3.concat(se2).value);

console.log(se.concat(se4).value);
